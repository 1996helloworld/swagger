...
namespace DataAccess
{
    public class DatabaseCommon
    {
        ...
        {
            Assembly asmb = Assembly.LoadFrom(System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "bin", "Highnet.Entity.dll"));
        ...
        /// <returns>int</returns>
        public static StringBuilder InsertSql(string tableName, ref Hashtable ht)
        {
        ...
        public static StringBuilder InsertSql<T>(T entity)
        {
            ...
            {
                if (prop.PropertyType.Name == "String" && (string)prop.GetValue(entity, null) == "&nbsp;")
                {
        ...
        /// <returns></returns>
        public static StringBuilder UpdateSql(string tableName, ref Hashtable ht, string pkName)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(" Update ");
            sb.Append(tableName);
        ...
        public static StringBuilder SelectSql<T>() where T : new()
        {
            ...
            if (tableName == "BOM") { strSql = string.Format(strSql, "*", tableName + " "); }
            else strSql = string.Format(strSql, sbColumns.ToString(), tableName + " ");
        ...
        public static StringBuilder SelectSql(string tableName)
        {
            ...
            strSql.Append("SELECT * FROM " + tableName + " WITH (NOLOCK) WHERE 1=1 ");//update by wangcong 2017.3.14
            return strSql;
        }
        /// <summary>
        /// 拼接 查询条数 SQL语句
