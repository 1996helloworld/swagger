...
namespace DataAccess.DataBase
{
    ...
    public class Database : IDatabase, IDisposable
    {
        ...
        {
            object val = 0;
            StringBuilder strSql = DatabaseCommon.InsertSql(tableName, ref ht);
        ...
        {
            object val = 0;
            StringBuilder strSql = DatabaseCommon.UpdateSql(tableName, ref ht, propertyName);
            DbParameter[] parameter = DatabaseCommon.GetParameter(ht);
            val = DbHelper.ExecuteNonQuery(CommandType.Text, strSql.ToString(), parameter);
            return Convert.ToInt32(val);
        }
        ...
        Hashtable IDatabase.FindHashtable(string tableName, string propertyName, object propertyValue)
        {
            throw new NotImplementedException();
        }

        Hashtable IDatabase.FindHashtable(string tableName, StringBuilder WhereSql)
        {
            throw new NotImplementedException();
        }

        Hashtable IDatabase.FindHashtable(string tableName, StringBuilder WhereSql, DbParameter[] parameters)
        {
            throw new NotImplementedException();
        }

        Hashtable IDatabase.FindHashtableBySql(string strSql)
        {
            throw new NotImplementedException();
        }

        Hashtable IDatabase.FindHashtableBySql(string strSql, DbParameter[] parameters)
        {
            throw new NotImplementedException();
        }
        #endregion
