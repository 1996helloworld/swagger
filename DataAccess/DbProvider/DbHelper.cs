...
namespace DataAccess
{
    ...
    public class DbHelper
    {
        ...
        {
            string ConStringDESEncrypt = "";
            ConStringDESEncrypt = "false";
            ConnectionString = ConfigurationManager.ConnectionStrings[connstring].ConnectionString;//System.Data.SqlClient
